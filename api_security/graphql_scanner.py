...
class GraphQLScanner:
    ...
    def __init__(self, graphql_url: str, headers: Optional[Dict[str, str]] = None):
        """
    ...
    def _graphql_query(self, query: str, variables: Optional[Dict[str, Any]] = None) -> Optional[requests.Response]:
        ...
        if response and response.status_code == 200:
            try:
                ...
                if "data" in data and "__schema" in data.get("data", {}):
                    ...
                    self._add_finding("introspection", {
                    ...
                    sensitive_keywords = ["admin", "internal", "private", "secret", "key", "password"]
                    sensitive_types = []
        ...
        if response:
            try:
                ...
                if "errors" in data:
                    ...
                    if any(keyword in error_msg.lower() for keyword in ["stack", "traceback", "file:", "line:"]):
...
GraphQL Security Risks:
  ...
  - Verbose error messages
    ...
    parser.add_argument('--test', choices=['introspection', 'depth', 'batch', 'alias', 'suggestions', 'errors'],
    ...
    parser.add_argument('--output', type=Path, default=Path('output/graphql_scan.json'),
